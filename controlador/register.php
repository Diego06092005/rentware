                ...
                if ($error === 0) {
                    if ($img_size > 10000000) { // Si el archivo es mayor de 1MB
                        ...
                        if (in_array($img_ex_lc, $allowed_exs)) {
                            ...
                            $img_upload_path = '../vista/uploads/'.$new_img_name;
                            move_uploaded_file($tmp_name, $img_upload_path);

                            // Ahora, $new_img_name tiene el nombre de la imagen cargada
                        } else {
...
<head>
    ...
    <style>
        body {
            ...
            align-items: center;
            height: 100vh;
            background-image: url('../vista/IMG/fondo_register.png');
